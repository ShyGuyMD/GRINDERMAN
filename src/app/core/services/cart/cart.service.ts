...
export class CartService {
    ...
    private coupon$: BehaviorSubject<Coupon | null> = new BehaviorSubject<Coupon | null>(null);
    private mercadoLibre$: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);
